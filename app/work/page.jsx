...
const projects = [
  {
    ...
    category: "frontend",
    title: "Project 1",
    Description: "Lorem Ipsum dolor sit amet, consectetur adipiscing elit. Cudipiditate magnam modi",
            ...
            <Swiper
              ...
              className="xl:h-[520px] mb-12" onSlideChange={handleSlideChange}>
                ...
                <WorkSliderBtns
                  ...
                  btnStyles="bg-red-500 hover:bg-red-500-hover text-primary text-[22px] w-[44px] h-[44px] flex justify-center items-center transition-all"
                />
            </Swiper>
          </div>
        </div>
